 ...
 * @author AhmedMahfouz
 */
public class Hashing extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         hashingMiD5 m=new   hashingMiD5();
           jTextField4.setText(m.encrpt(jTextField2.getText()));        // TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          ...
          try {
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"hash.pdf");
        } catch (Exception e) {
        }
