...
public class Combination extends javax.swing.JInternalFrame {
 ...
 c.get_plain_text(jTextField2.getText());
                c.create_matrix();
                c.generate_first_arr(0);
             jTextField4.setText(   c.generate_cipher());        
            }catch(Exception e){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         ...
         try {
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"trans.pdf");
        } catch (Exception e) {
        }
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ...
         if (jTextField12.getText().isEmpty()){
            ...
            try {
  combinationcode c=new  combinationcode();
 c.get_plain_text(jTextField12.getText());
                  c.create_matrix();
                c.generate_first_arr(1);
                
              jTextField9.setText(  c.generate_plain()); 
