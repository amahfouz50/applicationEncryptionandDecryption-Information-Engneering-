 ...
 * @author AhmedMahfouz
 */
public class DES extends javax.swing.JInternalFrame {
 ...
 DesMethodology myEncryptor= new  DesMethodology();
 
        String stringToEncrypt= jTextField2.getText().toString();
        String encrypted=myEncryptor.encrypt(stringToEncrypt);
        String decrypted=myEncryptor.decrypt(encrypted);
 
        jTextField4.setText( encrypted);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          ...
          try {
            Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"DES.pdf");
        } catch (Exception e) {
        }
        // TODO add your handling code here:
...
DesMethodology myEncryptor= new  DesMethodology();
        ...
        String stringToEncrypt= jTextField12.getText().toString();
         String decrypted=myEncryptor.decrypt(stringToEncrypt);
 
        jTextField9.setText( decrypted);
